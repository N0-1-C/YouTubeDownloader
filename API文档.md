...
暂停正在下载的任务。暂停后可通过恢复接口继续下载（yt-dlp 会自动跳过已下载的片段）。
...
恢复已暂停的下载任务。会重新启动下载线程，yt-dlp 会自动从已下载的进度继续。
...
取消下载任务。对于已暂停的任务会立即取消；对于正在下载的任务会设置取消标志，等待当前操作完成后终止。
